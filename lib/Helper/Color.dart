...
extension colors on ColorScheme {
  ...
  static const Color primary = Color(0xff5D942C);
  static const Color secondary = Color(0xffFB6803);
  ...
  static const Color grad1Color = Color(0xff7DAF45);
  static var grad2Color = Color(0xff7DAF45);
  static const Color lightWhite2 = Color(0xffEEF2F3);

  static const Color yellow = Color(0xfffdd901);

  static const Color red = Color(0xff7DAF45);
